...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmacyAPI.Models.ApplicationUserOtp", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PharmacyAPI.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmacyAPI.Models.SalesInvoiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PharmacyAPI.Models.ApplicationUserOtp", b =>
                {
                    b.HasOne("PharmacyAPI.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PharmacyAPI.Models.Chat", b =>
                {
                    b.HasOne("PharmacyAPI.Models.ApplicationUser", "Admin")
                        .WithMany("AdminChats")
                        .HasForeignKey("AdminId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("PharmacyAPI.Models.ApplicationUser", "Customer")
            ...
            modelBuilder.Entity("PharmacyAPI.Models.ChatMessage", b =>
                {
                    ...
                    b.HasOne("PharmacyAPI.Models.ApplicationUser", "Sender")
            ...
            modelBuilder.Entity("PharmacyAPI.Models.Notification", b =>
                {
                    ...
                    b.HasOne("PharmacyAPI.Models.ApplicationUser", "User")
                        .WithMany("Notifications")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PharmacyAPI.Models.SalesInvoiceItem", b =>
                {
                    ...
                    b.HasOne("PharmacyAPI.Models.SalesInvoice", "SalesInvoice")
